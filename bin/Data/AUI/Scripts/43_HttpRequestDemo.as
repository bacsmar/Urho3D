...
void HandleUpdate(StringHash eventType, VariantMap& eventData)
{
    ...
    else
    {
        ...
        {
            writeText ( "An error has occurred." ); //text.text = "An error has occurred.";
        ...
        else
        {
            ...
            {
                 writeText ( "Processing..." ); //text.text = "Processing...";
                ...
                if (val.isNull)
                    writeText ( "Invalid string." ); //text.text = "Invalid string.";
                else
                    writeText ("Your IP is: " + val.GetString() ); //text.text =  "Your IP is: " + val.GetString();
