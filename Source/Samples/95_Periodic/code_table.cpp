...
void PeriodicApp::setup_table( AWidget *mylayout )
{
    ATabContainer *pgtable = (ATabContainer *)mylayout->GetWidget("pagetable");
...
void PeriodicApp::HandleTableEvent(StringHash eventType, VariantMap& eventData)
{
    ...
    {
        ATabContainer *maintb = (ATabContainer *)uiview_->FindWidget("maintabs");
        ATabContainer *acttb = (ATabContainer *)uiview_->FindWidget("primarytabs");
        ATabContainer *semitb = (ATabContainer *)uiview_->FindWidget("moretabs");
        ATabContainer *viewtb = (ATabContainer *)uiview_->FindWidget("supporttabs");
        ATabContainer *supporttb = (ATabContainer *)uiview_->FindWidget("atomictabs");
